...
import numpy as np
from leda_cal2 import skymodel
...
if __name__ == "__main__":
    ...
    ff, lsts, C0 = load_data_252x('data/outriggers_2018-06-01_10H17M12S.h5', h_252x, f0, f1, lst0=11, lst1=12)
    ff, lsts, D0 = load_data_254x('data/outriggers_2018-06-01_10H17M12S.h5', h_254x, f0, f1, lst0=11, lst1=12)
    ff, lsts, E0 = load_data_255x('data/outriggers_2018-06-01_10H17M12S.h5', h_255x, f0, f1, lst0=11, lst1=12)


    s = skymodel.SkyModel('x', npol=11)
    s_x = s.generate_tsky(11.5, ff*1e6)
    ...
    plt.figure("ANT_FRAC")
    plt.plot(ff,  aC / s_x, label='252A')
    plt.plot(ff,  aD / s_x, label='254A')
    plt.plot(ff,  aE / s_x, label='255A')
    ...
    plt.minorticks_on()
    plt.legend()
    plt.savefig("img/02_ant_spec_frac.png")
